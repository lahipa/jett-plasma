...
const SectionSeven = () => {
  ...
  const imgX1Transform = useTransform(scrollYProgressSpring, [1, 0], [-130, 0])
  const textXTransform = useTransform(scrollYProgressSpring, [0, 1], [-70, 0])

  const textY3Transform = useTransform(scrollYProgressSpring, [0, 1], [170, 0])
  ...
  return (
    <section ref={ref} className="relative pt-[150px] pb-[80px] lg:pb-[300px]">
      <Container className="flex flex-col gap-[30px] lg:gap-[40px]">
        <motion.div style={{y: textY3Transform}}>
