...
import { CtaLayoutContact, SliderVideosHome, HomeSectionFour, HomeSectionOne, HomeSectionTwo, HomeSectionThree } from "./@clients";
...
export default function Home() {
  return (
    <>
      ...
      <HomeSectionThree/>
      <section className="relative pt-[30px] lg:pt-[50px] pb-[80px] lg:pb-[150px]">
      ...
      <section className="relative py-[80px] lg:py-[150px] bg-primary text-white rounded-[40px] lg:rounded-[80px]">
        <Container className="flex flex-col gap-[60px] lg:gap-[80px]">
          ...
          <div className="flex flex-col lg:flex-row-reverse items-center gap-[40px]">
              <div className="w-full lg:w-[420px] h-[162px] flex items-center justify-center rounded-full overflow-hidden bg-white">
                  <img src="/products/product-18.png" className="mix-blend-darken w-full h-full" />
              </div>
              <p className="text-[16px] lg:text-[18px] leading-[24px] lg:leading-[28px] lg:font-light flex-1">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-[40px]">
              <div className="w-full lg:w-[420px] h-[162px] flex items-center justify-center rounded-full overflow-hidden bg-white">
                  <img src="/products/product-19.png" className="mix-blend-darken w-full h-full" />
              </div>
              <p className="text-[16px] lg:text-[18px] leading-[24px] lg:leading-[28px] lg:font-light flex-1">
          ...
          <div className="flex flex-col lg:flex-row-reverse items-center gap-[40px]">
              <div className="w-full lg:w-[420px] h-[162px] flex items-center justify-center rounded-full overflow-hidden bg-white">
                  <img src="/products/product-20.png" className="mix-blend-darken w-full h-full" />
              </div>
              <p className="text-[16px] lg:text-[18px] leading-[24px] lg:leading-[28px] lg:font-light flex-1">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-[40px] mt-[60px] lg:mt-0 overflow-hidden lg:overflow-visible">
              ...
              <p className="pt-[384px] lg:pt-0 text-[16px] lg:text-[18px] leading-[24px] lg:leading-[28px] lg:font-light flex-1">
      ...
      <section className="relative pt-[150px] pb-[80px] lg:pb-[300px]">
        ...
        <div id="pattern-1" className="absolute top-[35px] lg:top-0 left-0 z-[1]">
      ...
      <section className="relative py-[80px] lg:py-[100px] bg-black text-white rounded-[40px] lg:rounded-[80px] z-[1]">
        <Container className="flex flex-col lg:flex-row-reverse items-stretch gap-[420px] lg:gap-[100px]">
          ...
          <div className="h-[480px] lg:w-[395px] relative flex items-center justify-center">
